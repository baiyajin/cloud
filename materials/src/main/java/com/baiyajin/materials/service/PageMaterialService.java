   ...
   private List<String> mulist = new ArrayList<>();
    {
        ...
        String ids = "8,9,10,11,12,13,16,17,19,20,21,22,23,24,28,29,30,32,33,37,40,42,43,46,47,45,18";
        String names =  "钢筋,钢板,钢管,型钢,钢绞线,钢丝绳,水泥,砌体材料," +
                "建筑用石,地基用材,混凝土,建筑砂浆,电力电缆,电气装备用电线电缆,非金属管,复合管,金属管,防水卷材,防水涂料," +
                "轻骨料,光纤光缆,混凝土管,其他电气材料,防水砂浆,混凝土预制桩,特种玻璃,建筑用砂";
        String mus = "吨,吨,吨,吨,千克,千克,吨,吨,立方米,立方米,立方米,立方米,米,米,米,米,吨,平方米,千克,立方米,米,米,米,吨,米,平方米,立方米";
